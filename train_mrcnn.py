...
transforms = v2.Compose(        # Applied to both image, mask
    [
        v2.ToImage(),
...
trainset = CocoDetection(root='/home/joseph/study/multimodal/ai_editor/train2017', annFile='/home/joseph/study/multimodal/ai_editor/annotations/instances_train2017_adj.json', transforms=transforms)
trainset = datasets.wrap_dataset_for_transforms_v2(trainset, target_keys=("boxes", "labels", "masks"))


validset = CocoDetection(root='/home/baekw92/ai_editor/val2017', annFile='/home/joseph/study/multimodal/ai_editor/annotations/instances_val2017.json', transforms=transforms_test)
